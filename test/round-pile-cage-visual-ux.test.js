...
test('dynamic print renders exactly five QR/status cards with canonical component visuals', () => {
  ...
  assert.match(hoop, /data-shape-kind="pile-hoop-component"/); assert.match(hoop, /PCS 5/); assert.match(hoop, /UNIT 131\.9 cm/); assert.match(hoop, /TOTAL 659\.5 cm/); assert.match(hoop, /data-spiral-diameter-mm="420"/); assert.match(hoop, /Ø 42 ס״מ/);
