...
function calculateRoundPileCage(shape = {}) {
  ...
  while (straightRemaining > 0 || bentRemaining > 0) {
    ...
    if (bentRemaining > 0) { bars.push({ type: 'L', lengthMm: bentLengthMm, mainLengthMm: bentMainLengthMm, bendLengthMm }); bentRemaining -= 1; }
  }
