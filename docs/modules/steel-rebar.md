...
## כלל סימון זווית ישרה (90°)

זווית 90° מסומנת בסימן ריבוע פינה בלבד — אין לכתוב טקסט "90°" לצד הסימן, כי הסימן עצמו אומר זאת. טקסט מעלות מודפס רק לזוויות שאינן 90° (למשל 45°, 135°). הכלל חל על כל ציורי הצורות במסמכים (כרטיסיות ייצור, A4, תעודת משלוח). בתצוגת העורך המהירה שאין בה סימן ריבוע — הטקסט נשאר.
